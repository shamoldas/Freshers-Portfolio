...
<section>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
             <hr><center><h3 style="color:#0A84AC;letter-spacing: 8px;"><b>CONTACT</b></h3></center><hr/>
...
<section>
    <div class="container">
  	<div class="row">
    		<div class="col">
			<h4 style="margin-top:1em;font-family: Georgia, serif;text-decoration:underline;"><center>Feel Free & Contact</center></h4>
		</div>
       </div>
    </div>
</section>
...
<div class="container">
  <div class="row">
    ...
    <div class="col">
<form class="row g-3 needs-validation" novalidate method="post" action="contactdatainsert.php">
 
  <div class="col-md-6">
    <label for="validationCustom02" class="form-label">Your Name</label>
    <input type="text" name="name" class="form-control" id="validationCustom02" value="Shamol Das" required="required" >
